...
FORECAST_MODE = "Next 15-Min Forecast"
...
# ==============================================================
    ...
    if uploaded_file:
        ...
        # MATPLOTLIB GRAPH
        fig, ax = plt.subplots()
        ax.plot(df["Predicted_Power_kW"])
        ax.set_title("Predicted Solar Power Trend")
        ax.set_xlabel("Index")
...
# ==============================================================
    ...
    try:
        ...
        st.success(
            f"🏆 Best Model: {best['Model']} | RMSE: {best['RMSE']}"
        )
...
# ==============================================================
    ...
    try:
        ...
        # LINE GRAPH
        fig, ax = plt.subplots()
        ax.plot(comparison_df["Actual"].head(200), label="Actual")
        ax.plot(comparison_df["Predicted"].head(200), label="Predicted")
        ...
        ax2.scatter(comparison_df["Actual"], comparison_df["Predicted"])
...
# ==============================================================
    ...
    if st.button("🔮 Generate Forecast"):
        ...
        ax.plot(
            forecast_df["Time"],
            forecast_df["Forecasted Power (kW)"],
            marker="o"
        )

        ax.set_title("Next 15-Minute Solar Forecast")
        ax.set_xlabel("Time")
        ax.set_ylabel("Power (kW)")
